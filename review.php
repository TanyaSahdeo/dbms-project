				...
				<div class="container">
					<section>
						<header class="major">
							...
							<b>User Name*:</b>&nbsp&nbsp&nbsp&nbsp<input type="text" name="user_name" required>
							<input type="submit">
							</form>
<?php
  $conn=mysqli_connect("localhost","root","","tourism");
  $bi = $_POST['user_name'];
  $sql = "SELECT USER_NAME as a,source_city as b,destination_city as c,no_of_people as d,package_price as e,hotel_name as f,hotel_price as g,airline as h,flight_date as i,flight_time as j,total_price as k,book_id as l
  from v2
  where user_name= '$bi'";
