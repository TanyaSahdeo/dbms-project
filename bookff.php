<?php
	...
	VALUES('$_POST[aline]','$_POST[date]','$_POST[time]','$_POST[scity]','$_POST[dcity]','$_POST[username]','$_POST[f_name]','$_POST[l_name]','$_POST[phno]','$_POST[email]')";
	if(!mysqli_query($conn,$sql))
	{
		die('Error: ');
	}
	header("Location: rev1.php");
	mysqli_close($conn);
?>